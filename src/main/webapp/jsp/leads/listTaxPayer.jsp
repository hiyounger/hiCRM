...
<div class="container">
	...
	<div style="margin-left: 550px">
		<input class="easyui-validatebox" type="text" id="payerCode" name="payerCode" placeholder="请输入线索名称/电话" style="width:166px;height:36px;line-height:35px;border-radius: 7px;"/>
		<%--纳税人名称: <input class="easyui-textbox" type="text" id="payerName" name="payerName" style="width:166px;height:35px;line-height:35px;"/>--%>

		<a style=" background-color: blue;color: white; width: 70px;height: 36px;border-radius: 7px;font-family: 微软雅黑" id="searchBtn" class="easyui-linkbutton" iconCls="icon-search" data-options="selected:true">查询</a>
		<button style="left: 450px;background-color: blue;color: white; width: 70px;height: 36px;border-radius: 7px;font-family: 微软雅黑" iconCls="icon-reload">重置</button>

		<%--<button id="addLeads" data-options="iconCls:'icon-add'">添加线索人</button>--%>
		<button style="background-color: blue;color: white; width: 90px;height: 36px;border-radius: 7px;font-family: 微软雅黑" id="addLeads" onclick="addLeads()">新建线索</button>
	</div>
